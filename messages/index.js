...
var nearby = require("./dialogs/nearby.js");
...
dialog.matches('nearby_services', [
  (session) => {
    session.beginDialog('/nearby_services');
  }
]);

dialog.matches('nearby_amenities', [
  (session) => {
    session.beginDialog('/nearby_amenities');
  }
]);

dialog.matches('nearby_events', [
  (session) => {
    session.beginDialog('/nearby_events');
  }
]);
...
bot.dialog('/nearby_services', nearby.services); //describes the features
bot.dialog('/nearby_amenities', nearby.amenities); //describes the features
bot.dialog('/nearby_events', nearby.events); //describes the features
